...
<html lang="en-US">
  <head>
    ...
    <script>
      ...
      {
        document.getElementById("clubNameInput").removeAttribute("disabled");
        document.getElementById("noCourseNameInput").removeAttribute("disabled");

        if (!document.getElementById("noCourseNameInput").checked)
        {
          document.getElementById("courseNameInput").removeAttribute("disabled");
        }

        document.getElementById("stateInput").removeAttribute("disabled");
        document.getElementById("countryInput").removeAttribute("disabled");
        document.getElementById("numHolesInput").removeAttribute("disabled");
        document.getElementById("yardageUnitsInput").removeAttribute("disabled");
        document.getElementById("addTeeBox").removeAttribute("hidden");
        ...
        elems = document.getElementsByClassName("colourInputs");
        ...
        elems = document.getElementsByClassName("distanceInputs");
        ...
        elems = document.getElementsByClassName("deleteTeeBox");
  ...
  <body>
    ...
    <?php
      ...
      if ($_SERVER["REQUEST_METHOD"] == "POST" && $_POST["username"])
      {
        ...
        $courseResults = $conn->query(sprintf(GET_COURSE, $courseId));

        if ($courseResults->num_rows == 1)
        {
          $courseDeleted = false;
          $course = $courseResults->fetch_assoc();

          $clubName = $course["clubName"];
          $courseName = $course["courseName"];
          $stateLocation = $course["stateLocation"];
          $countryLocation = $course["countryLocation"];
          $numHoles = $course["numHoles"];
          $yardageUnits = $course["yardageUnits"];
          $par1 = $course["par1"];
          $par2 = $course["par2"];
          $par3 = $course["par3"];
          $par4 = $course["par4"];
          ...
          $teeBoxResults = $conn->query(sprintf(GET_TEEBOXES, $courseId));
          $numTeeBoxes = $teeBoxResults->num_rows;

          for ($i = 0; $i < $numTeeBoxes; $i++)
          {
            $teeBox = $teeBoxResults->fetch_assoc();

            array_push($colour, $teeBox["colour"]);
            array_push($distance1, $teeBox["distance1"]);
            array_push($distance2, $teeBox["distance2"]);
            array_push($distance3, $teeBox["distance3"]);
            array_push($distance4, $teeBox["distance4"]);
            array_push($distance5, $teeBox["distance5"]);
            array_push($distance6, $teeBox["distance6"]);
            array_push($distance7, $teeBox["distance7"]);
            array_push($distance8, $teeBox["distance8"]);
            array_push($distance9, $teeBox["distance9"]);
            array_push($distance10, $teeBox["distance10"]);
            array_push($distance11, $teeBox["distance11"]);
            array_push($distance12, $teeBox["distance12"]);
            array_push($distance13, $teeBox["distance13"]);
            array_push($distance14, $teeBox["distance14"]);
            array_push($distance15, $teeBox["distance15"]);
            array_push($distance16, $teeBox["distance16"]);
            array_push($distance17, $teeBox["distance17"]);
            array_push($distance18, $teeBox["distance18"]);
          }
        }
      }
    ...
    <div id="titleBanner">
      <h1 id="title"><?php echo $clubName; if ($courseName) { echo " (", $courseName, ")"; } ?></h1>
    </div>

    <div id="formContainer">
      <form id="form" method="post" action="edit-course.php" onsubmit="return checkInput()">
        <input type="text" name="username" value="<?php echo $username; ?>" hidden>
        <input type="number" name="courseID" value="<?php echo $courseId; ?>" hidden>
        <input id="numTeeBoxes" type="number" name="numTeeBoxes" value="" hidden>

        <button id="editButton" onclick="return undisableInput()">Edit Course</button>
        ...
        <div class="inputContainer">
          ...
          <input id="clubNameInput" type="text" name="clubName" value="<?php echo $clubName; ?>" disabled>

          <div class="secondColumnInputContainer">
            Course&nbsp;Name:&nbsp;<span id="courseNameWarning" class="warning"></span><br>
            <input id="courseNameInput" type="text" name="courseName" value="<?php echo $courseName; ?>" disabled>
            <input id="noCourseNameInput" type="checkbox" onclick="courseNameDisable(this.checked)" disabled<?php if ($clubName && $courseName == "") { echo " checked"; } ?>>
        ...
        <div class="inputContainer">
          ...
          <input id="stateInput" type="text" name="stateLocation" value="<?php echo $stateLocation; ?>" disabled>

          <div class="secondColumnInputContainer">
            Country:&nbsp;<span id="countryWarning" class="warning"></span><br>
            <select id="countryInput" name="countryLocation" disabled>
        ...
        <div class="inputContainer">
          ...
          <select id="numHolesInput" name="numHoles" onchange="changeNumHoles(this.value)" disabled>
          ...
          <div class="secondColumnInputContainer">
            ...
            <select id="yardageUnitsInput" name="yardageUnits" disabled>
        ...
        <div id="parsContainer" class="inputContainer" hidden>
          ...
          <table>
            ...
            <tr>
              <td>Par</td>
              <td><input class="first9ParsInputs" type="number" name="par1" min="3" max="5" oninput="addFirst9Pars()" value="<?php echo $par1; ?>" disabled></td>
              <td><input class="first9ParsInputs" type="number" name="par2" min="3" max="5" oninput="addFirst9Pars()" value="<?php echo $par2; ?>" disabled></td>
              <td><input class="first9ParsInputs" type="number" name="par3" min="3" max="5" oninput="addFirst9Pars()" value="<?php echo $par3; ?>" disabled></td>
              <td><input class="first9ParsInputs" type="number" name="par4" min="3" max="5" oninput="addFirst9Pars()" value="<?php echo $par4; ?>" disabled></td>
              <td><input class="first9ParsInputs" type="number" name="par5" min="3" max="5" oninput="addFirst9Pars()" value="<?php echo $par5; ?>" disabled></td>
              <td><input class="first9ParsInputs" type="number" name="par6" min="3" max="5" oninput="addFirst9Pars()" value="<?php echo $par6; ?>" disabled></td>
              <td><input class="first9ParsInputs" type="number" name="par7" min="3" max="5" oninput="addFirst9Pars()" value="<?php echo $par7; ?>" disabled></td>
              <td><input class="first9ParsInputs" type="number" name="par8" min="3" max="5" oninput="addFirst9Pars()" value="<?php echo $par8; ?>" disabled></td>
              <td><input class="first9ParsInputs" type="number" name="par9" min="3" max="5" oninput="addFirst9Pars()" value="<?php echo $par9; ?>" disabled></td>
          ...
          <table id="second9ParsTable">
            ...
            <tr>
              <td>Par</td>
              <td><input class="second9ParsInputs" type="number" name="par10" min="3" max="5" oninput="addSecond9Pars()" value="<?php echo $par10; ?>" disabled></td>
              <td><input class="second9ParsInputs" type="number" name="par11" min="3" max="5" oninput="addSecond9Pars()" value="<?php echo $par11; ?>" disabled></td>
              <td><input class="second9ParsInputs" type="number" name="par12" min="3" max="5" oninput="addSecond9Pars()" value="<?php echo $par12; ?>" disabled></td>
              <td><input class="second9ParsInputs" type="number" name="par13" min="3" max="5" oninput="addSecond9Pars()" value="<?php echo $par13; ?>" disabled></td>
              <td><input class="second9ParsInputs" type="number" name="par14" min="3" max="5" oninput="addSecond9Pars()" value="<?php echo $par14; ?>" disabled></td>
              <td><input class="second9ParsInputs" type="number" name="par15" min="3" max="5" oninput="addSecond9Pars()" value="<?php echo $par15; ?>" disabled></td>
              <td><input class="second9ParsInputs" type="number" name="par16" min="3" max="5" oninput="addSecond9Pars()" value="<?php echo $par16; ?>" disabled></td>
              <td><input class="second9ParsInputs" type="number" name="par17" min="3" max="5" oninput="addSecond9Pars()" value="<?php echo $par17; ?>" disabled></td>
              <td><input class="second9ParsInputs" type="number" name="par18" min="3" max="5" oninput="addSecond9Pars()" value="<?php echo $par18; ?>" disabled></td>
        ...
        <div id="yardagesContainer" class="inputContainer" hidden>
          ...
          <div class="distanceContainer">
            ...
            <input id="teeBoxColourInput_1" class="colourInputs" type="text" name="colour_1" value="<?php echo $colour[0]; ?>" disabled>&nbsp;<span id="distancesWarning_1" class="warning"></span><br>
            <table>
              <tr>
                <td>Hole</td>
                <td>1</td>
              ...
              <tr>
                <td>Distance</td>
                <td><input class="distanceInputs first9DistancesInputs_1" type="number" name="distance1_1" min="0" max="1000" oninput="addFirst9Distances(1)" value="<?php echo $distance1[0]; ?>" disabled></td>
                <td><input class="distanceInputs first9DistancesInputs_1" type="number" name="distance2_1" min="0" max="1000" oninput="addFirst9Distances(1)" value="<?php echo $distance2[0]; ?>" disabled></td>
                <td><input class="distanceInputs first9DistancesInputs_1" type="number" name="distance3_1" min="0" max="1000" oninput="addFirst9Distances(1)" value="<?php echo $distance3[0]; ?>" disabled></td>
                <td><input class="distanceInputs first9DistancesInputs_1" type="number" name="distance4_1" min="0" max="1000" oninput="addFirst9Distances(1)" value="<?php echo $distance4[0]; ?>" disabled></td>
                <td><input class="distanceInputs first9DistancesInputs_1" type="number" name="distance5_1" min="0" max="1000" oninput="addFirst9Distances(1)" value="<?php echo $distance5[0]; ?>" disabled></td>
                <td><input class="distanceInputs first9DistancesInputs_1" type="number" name="distance6_1" min="0" max="1000" oninput="addFirst9Distances(1)" value="<?php echo $distance6[0]; ?>" disabled></td>
                <td><input class="distanceInputs first9DistancesInputs_1" type="number" name="distance7_1" min="0" max="1000" oninput="addFirst9Distances(1)" value="<?php echo $distance7[0]; ?>" disabled></td>
                <td><input class="distanceInputs first9DistancesInputs_1" type="number" name="distance8_1" min="0" max="1000" oninput="addFirst9Distances(1)" value="<?php echo $distance8[0]; ?>" disabled></td>
                <td><input class="distanceInputs first9DistancesInputs_1" type="number" name="distance9_1" min="0" max="1000" oninput="addFirst9Distances(1)" value="<?php echo $distance9[0]; ?>" disabled></td>
            ...
            <table id="second9DistancesTable_1">
              ...
              <tr>
              <td>Distance</td>
                <td><input class="distanceInputs second9DistancesInputs_1" type="number" name="distance10_1" min="0" max="1000" oninput="addSecond9Distances(1)" value="<?php echo $distance10[0]; ?>" disabled></td>
                <td><input class="distanceInputs second9DistancesInputs_1" type="number" name="distance11_1" min="0" max="1000" oninput="addSecond9Distances(1)" value="<?php echo $distance11[0]; ?>" disabled></td>
                <td><input class="distanceInputs second9DistancesInputs_1" type="number" name="distance12_1" min="0" max="1000" oninput="addSecond9Distances(1)" value="<?php echo $distance12[0]; ?>" disabled></td>
                <td><input class="distanceInputs second9DistancesInputs_1" type="number" name="distance13_1" min="0" max="1000" oninput="addSecond9Distances(1)" value="<?php echo $distance13[0]; ?>" disabled></td>
                <td><input class="distanceInputs second9DistancesInputs_1" type="number" name="distance14_1" min="0" max="1000" oninput="addSecond9Distances(1)" value="<?php echo $distance14[0]; ?>" disabled></td>
                <td><input class="distanceInputs second9DistancesInputs_1" type="number" name="distance15_1" min="0" max="1000" oninput="addSecond9Distances(1)" value="<?php echo $distance15[0]; ?>" disabled></td>
                <td><input class="distanceInputs second9DistancesInputs_1" type="number" name="distance16_1" min="0" max="1000" oninput="addSecond9Distances(1)" value="<?php echo $distance16[0]; ?>" disabled></td>
                <td><input class="distanceInputs second9DistancesInputs_1" type="number" name="distance17_1" min="0" max="1000" oninput="addSecond9Distances(1)" value="<?php echo $distance17[0]; ?>" disabled></td>
                <td><input class="distanceInputs second9DistancesInputs_1" type="number" name="distance18_1" min="0" max="1000" oninput="addSecond9Distances(1)" value="<?php echo $distance18[0]; ?>" disabled></td>
                <td id="second9DistancesTotal_1">0</td>
                <td id="full18DistancesTotal_1">0</td>
              </tr>
            </table><br>
          </div>
          <button id="addTeeBox" onclick="return addTeeBoxInput()" hidden>Add Tee Box</button>
        </div>

        <input id="editSubmit" type="submit" value="Update Course" hidden>
      </form>
    </div>
    ...
    <?php
          ...
          if ($numTeeBoxes > 1)
          {
            ...
            for ($i = 1; $i < $numTeeBoxes; $i++)
            {
              echo "numTeeBoxes += 1;
                    ...
                    newYardageHtml += \"<div class=\\\"distanceContainer\\\">\\
                                        Tee&nbsp;Box&nbsp;\" + numTeeBoxes + \"&nbsp;Colour:&nbsp;<span id=\\\"colourWarning_\" + numTeeBoxes + \"\\\" class=\\\"warning\\\"></span><br>\\
                                        <input id=\\\"teeBoxColourInput_\" + numTeeBoxes + \"\\\" class=\\\"colourInputs\\\" type=\\\"text\\\" name=\\\"colour_\" + numTeeBoxes + \"\\\" value=\\\"", $colour[$i], "\\\" disabled>&nbsp;\\
                                        <button class=\\\"deleteTeeBox\\\" onclick=\\\"return deleteTeeBoxInput(\" + numTeeBoxes + \")\\\" hidden>Delete Tee Box</button>&nbsp;<span id=\\\"distancesWarning_\" + numTeeBoxes + \"\\\" class=\\\"warning\\\"></span><br>\\
                                        <table>\\
                                          <tr>\\
                                            <td>Hole</td>\\
                                            <td>1</td>\\
                                          ...
                                          <tr>\\
                                            <td>Distance</td>\\
                                            <td><input class=\\\"distanceInputs first9DistancesInputs_\" + numTeeBoxes + \"\\\" type=\\\"number\\\" name=\\\"distance1_\" + numTeeBoxes + \"\\\" min=\\\"0\\\" max=\\\"1000\\\" oninput=\\\"addFirst9Distances(\" + numTeeBoxes + \")\\\" value=\\\"", $distance1[$i], "\\\" disabled></td>\\
                                            <td><input class=\\\"distanceInputs first9DistancesInputs_\" + numTeeBoxes + \"\\\" type=\\\"number\\\" name=\\\"distance2_\" + numTeeBoxes + \"\\\" min=\\\"0\\\" max=\\\"1000\\\" oninput=\\\"addFirst9Distances(\" + numTeeBoxes + \")\\\" value=\\\"", $distance2[$i], "\\\" disabled></td>\\
                                            <td><input class=\\\"distanceInputs first9DistancesInputs_\" + numTeeBoxes + \"\\\" type=\\\"number\\\" name=\\\"distance3_\" + numTeeBoxes + \"\\\" min=\\\"0\\\" max=\\\"1000\\\" oninput=\\\"addFirst9Distances(\" + numTeeBoxes + \")\\\" value=\\\"", $distance3[$i], "\\\" disabled></td>\\
                                            <td><input class=\\\"distanceInputs first9DistancesInputs_\" + numTeeBoxes + \"\\\" type=\\\"number\\\" name=\\\"distance4_\" + numTeeBoxes + \"\\\" min=\\\"0\\\" max=\\\"1000\\\" oninput=\\\"addFirst9Distances(\" + numTeeBoxes + \")\\\" value=\\\"", $distance4[$i], "\\\" disabled></td>\\
                                            <td><input class=\\\"distanceInputs first9DistancesInputs_\" + numTeeBoxes + \"\\\" type=\\\"number\\\" name=\\\"distance5_\" + numTeeBoxes + \"\\\" min=\\\"0\\\" max=\\\"1000\\\" oninput=\\\"addFirst9Distances(\" + numTeeBoxes + \")\\\" value=\\\"", $distance5[$i], "\\\" disabled></td>\\
                                            <td><input class=\\\"distanceInputs first9DistancesInputs_\" + numTeeBoxes + \"\\\" type=\\\"number\\\" name=\\\"distance6_\" + numTeeBoxes + \"\\\" min=\\\"0\\\" max=\\\"1000\\\" oninput=\\\"addFirst9Distances(\" + numTeeBoxes + \")\\\" value=\\\"", $distance6[$i], "\\\" disabled></td>\\
                                            <td><input class=\\\"distanceInputs first9DistancesInputs_\" + numTeeBoxes + \"\\\" type=\\\"number\\\" name=\\\"distance7_\" + numTeeBoxes + \"\\\" min=\\\"0\\\" max=\\\"1000\\\" oninput=\\\"addFirst9Distances(\" + numTeeBoxes + \")\\\" value=\\\"", $distance7[$i], "\\\" disabled></td>\\
                                            <td><input class=\\\"distanceInputs first9DistancesInputs_\" + numTeeBoxes + \"\\\" type=\\\"number\\\" name=\\\"distance8_\" + numTeeBoxes + \"\\\" min=\\\"0\\\" max=\\\"1000\\\" oninput=\\\"addFirst9Distances(\" + numTeeBoxes + \")\\\" value=\\\"", $distance8[$i], "\\\" disabled></td>\\
                                            <td><input class=\\\"distanceInputs first9DistancesInputs_\" + numTeeBoxes + \"\\\" type=\\\"number\\\" name=\\\"distance9_\" + numTeeBoxes + \"\\\" min=\\\"0\\\" max=\\\"1000\\\" oninput=\\\"addFirst9Distances(\" + numTeeBoxes + \")\\\" value=\\\"", $distance9[$i], "\\\" disabled></td>\\
                                            <td id=\\\"first9DistancesTotal_\" + numTeeBoxes + \"\\\">0</td>\\
                                          </tr>\\
                                        </table>\\
                                        <table id=\\\"second9DistancesTable_\" + numTeeBoxes + \"\\\">\\
                                          ...
                                          <tr>\\
                                          <td>Distance</td>\\
                                            <td><input class=\\\"distanceInputs second9DistancesInputs_\" + numTeeBoxes + \"\\\" type=\\\"number\\\" name=\\\"distance10_\" + numTeeBoxes + \"\\\" min=\\\"0\\\" max=\\\"1000\\\" oninput=\\\"addSecond9Distances(\" + numTeeBoxes + \")\\\" value=\\\"", $distance10[$i], "\\\" disabled></td>\\
                                            <td><input class=\\\"distanceInputs second9DistancesInputs_\" + numTeeBoxes + \"\\\" type=\\\"number\\\" name=\\\"distance11_\" + numTeeBoxes + \"\\\" min=\\\"0\\\" max=\\\"1000\\\" oninput=\\\"addSecond9Distances(\" + numTeeBoxes + \")\\\" value=\\\"", $distance11[$i], "\\\" disabled></td>\\
                                            <td><input class=\\\"distanceInputs second9DistancesInputs_\" + numTeeBoxes + \"\\\" type=\\\"number\\\" name=\\\"distance12_\" + numTeeBoxes + \"\\\" min=\\\"0\\\" max=\\\"1000\\\" oninput=\\\"addSecond9Distances(\" + numTeeBoxes + \")\\\" value=\\\"", $distance12[$i], "\\\" disabled></td>\\
                                            <td><input class=\\\"distanceInputs second9DistancesInputs_\" + numTeeBoxes + \"\\\" type=\\\"number\\\" name=\\\"distance13_\" + numTeeBoxes + \"\\\" min=\\\"0\\\" max=\\\"1000\\\" oninput=\\\"addSecond9Distances(\" + numTeeBoxes + \")\\\" value=\\\"", $distance13[$i], "\\\" disabled></td>\\
                                            <td><input class=\\\"distanceInputs second9DistancesInputs_\" + numTeeBoxes + \"\\\" type=\\\"number\\\" name=\\\"distance14_\" + numTeeBoxes + \"\\\" min=\\\"0\\\" max=\\\"1000\\\" oninput=\\\"addSecond9Distances(\" + numTeeBoxes + \")\\\" value=\\\"", $distance14[$i], "\\\" disabled></td>\\
                                            <td><input class=\\\"distanceInputs second9DistancesInputs_\" + numTeeBoxes + \"\\\" type=\\\"number\\\" name=\\\"distance15_\" + numTeeBoxes + \"\\\" min=\\\"0\\\" max=\\\"1000\\\" oninput=\\\"addSecond9Distances(\" + numTeeBoxes + \")\\\" value=\\\"", $distance15[$i], "\\\" disabled></td>\\
                                            <td><input class=\\\"distanceInputs second9DistancesInputs_\" + numTeeBoxes + \"\\\" type=\\\"number\\\" name=\\\"distance16_\" + numTeeBoxes + \"\\\" min=\\\"0\\\" max=\\\"1000\\\" oninput=\\\"addSecond9Distances(\" + numTeeBoxes + \")\\\" value=\\\"", $distance16[$i], "\\\" disabled></td>\\
                                            <td><input class=\\\"distanceInputs second9DistancesInputs_\" + numTeeBoxes + \"\\\" type=\\\"number\\\" name=\\\"distance17_\" + numTeeBoxes + \"\\\" min=\\\"0\\\" max=\\\"1000\\\" oninput=\\\"addSecond9Distances(\" + numTeeBoxes + \")\\\" value=\\\"", $distance17[$i], "\\\" disabled></td>\\
                                            <td><input class=\\\"distanceInputs second9DistancesInputs_\" + numTeeBoxes + \"\\\" type=\\\"number\\\" name=\\\"distance18_\" + numTeeBoxes + \"\\\" min=\\\"0\\\" max=\\\"1000\\\" oninput=\\\"addSecond9Distances(\" + numTeeBoxes + \")\\\" value=\\\"", $distance18[$i], "\\\" disabled></td>\\
                                            <td id=\\\"second9DistancesTotal_\" + numTeeBoxes + \"\\\">0</td>\\
                                            <td id=\\\"full18DistancesTotal_\" + numTeeBoxes + \"\\\">0</td>\\
                                          </tr>\\
                                        </table><br>\\
      ...
      {
        echo "<script>
                window.alert(\"This course no longer exists.\");
                document.getElementById(\"viewCoursesSubmit\").click();
              </script>";
      }
    ?>
  </body>
