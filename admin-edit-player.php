  ...
  <head>
    ...
    <script>
      ...
      function undisableInput()
      {
        ...
        document.getElementById("myKadInput").removeAttribute("disabled");
        document.getElementById("passportInput").removeAttribute("disabled");
        document.getElementById("noIdInput").removeAttribute("disabled");
        ...
        document.getElementById("addressInput").removeAttribute("disabled");
        document.getElementById("noAddressInput").removeAttribute("disabled");
        document.getElementById("countryInput").removeAttribute("disabled");
        document.getElementById("emailInput").removeAttribute("disabled");
        document.getElementById("mobileInput").removeAttribute("disabled");
        document.getElementById("noMobileInput").removeAttribute("disabled");
        document.getElementById("handicapInput").removeAttribute("disabled");
        document.getElementById("noHandicapInput").removeAttribute("disabled");
        document.getElementById("nhsInput").removeAttribute("disabled");
        document.getElementById("homeClubInput").removeAttribute("disabled");
        document.getElementById("noHomeClubInput").removeAttribute("disabled");
        document.getElementById("guardianNameInput").removeAttribute("disabled");
        document.getElementById("guardianMobileInput").removeAttribute("disabled");
        document.getElementById("mensCutInput").removeAttribute("disabled");
        document.getElementById("ladiesCutInput").removeAttribute("disabled");
        document.getElementById("noTShirtInput").removeAttribute("disabled");
        document.getElementById("xsSizeInput").removeAttribute("disabled");
        document.getElementById("sSizeInput").removeAttribute("disabled");
        document.getElementById("mSizeInput").removeAttribute("disabled");
        document.getElementById("lSizeInput").removeAttribute("disabled");
        document.getElementById("xlSizeInput").removeAttribute("disabled");
        document.getElementById("xxlSizeInput").removeAttribute("disabled");
        ...
        addressDisable(document.getElementById("noAddressInput").checked);
        mobileDisable(document.getElementById("noMobileInput").checked);
        handicapDisable(document.getElementById("noHandicapInput").checked);
        homeClubDisable(document.getElementById("noHomeClubInput").checked);
        tShirtDisable(document.getElementById("noTShirtInput").checked);
  ...
  <body>
    ...
    <?php
      ...
      if ($_SERVER["REQUEST_METHOD"] == "POST" && $_POST["username"])
      {
        ...
        $playerResults = $conn->query(sprintf(GET_PLAYER, $playerId));

        if ($playerResults->num_rows == 1)
        {
          $playerDeleted = false;
          $player = $playerResults->fetch_assoc();

          $firstName = $player["firstName"];
          $lastName = $player["lastName"];
          $myKadNumber = $player["myKadNumber"];
          ...
          $dateOfBirth = strval($player["yearOfBirth"]) . "-";
          if ($player["monthOfBirth"] < 10)
          {
            $dateOfBirth .= "0";
          }
          $dateOfBirth .= strval($player["monthOfBirth"]) . "-";
          if ($player["dayOfBirth"] < 10)
          {
            $dateOfBirth .= "0";
          }
          $dateOfBirth .= strval($player["dayOfBirth"]);
          ...
          $nhsNumber = $player["nhsNumber"];
          $homeClub = $player["homeClub"];
          $guardianName = $player["guardianName"];
          $guardianMobileNumber = $player["guardianMobileNumber"];
          $tShirtSize = $player["tShirtSize"];
          $tShirtCut = $player["tShirtCut"];
        }
      }
    ...
    <div id="titleBanner">
      <h1 id="title"><?php echo $firstName, "&nbsp;", $lastName; ?></h1>
    </div>

    <div id="formContainer">
      <form id="form" method="post" action="edit-player.php" onsubmit="return checkInput()">
        <input type="text" name="username" value="<?php echo $username; ?>" hidden>
        <input type="number" name="playerID" value="<?php echo $playerId; ?>" hidden>
        <input id="lastUpdatedDateInput" type="text" name="lastUpdatedDate" hidden>

        <button id="editButton" onclick="return undisableInput()">Edit Player</button>
        ...
        <div class="inputContainer">
          ...
          <input id="firstNameInput" type="text" name="firstName" value="<?php echo $firstName; ?>" disabled>

          <div class="secondColumnInputContainer">
            Last&nbsp;Name:&nbsp;<span id="lastNameWarning" class="warning"></span><br>
            <input id="lastNameInput" type="text" name="lastName" value="<?php echo $lastName; ?>" disabled>
          </div>
        </div>

        <div class="inputContainer">
          MyKad/Passport&nbsp;Number:&nbsp;<span id="idWarning" class="warning"></span><br>
          <input id="myKadInput" type="radio" name="idOption" onclick="document.getElementById('idInput').removeAttribute('disabled'); document.getElementById('idInput').placeholder = 'Eg: 000411-12-3456';" value="M"<?php if ($idOption == "M") { echo " checked"; } ?> disabled>
          <label for="myKadInput">MyKad</label>&nbsp;
          <input id="passportInput" type="radio" name="idOption" onclick="document.getElementById('idInput').removeAttribute('disabled'); document.getElementById('idInput').placeholder = '';" value="P"<?php if ($idOption == "P") { echo " checked"; } ?> disabled>
          <label for="passportInput">Passport</label>&nbsp;
          <input id="noIdInput" type="radio" name="idOption" onclick="document.getElementById('idInput').setAttributeNode(document.createAttribute('disabled')); document.getElementById('idInput').placeholder = '';" value="N"<?php if ($idOption == "N") { echo " checked"; } ?> disabled>
          <label for="noIdInput">N/A</label><br>
          <input id="idInput" type="text" name="idNumber" value="<?php echo $myKadNumber, $passportNumber; ?>" disabled>
        </div>

        <div class="inputContainer">
          Date&nbsp;of&nbsp;Birth:&nbsp;<span id="dobWarning" class="warning"></span><br>
          <input id="dobInput" type="date" name="dateOfBirth" value="<?php echo $dateOfBirth; ?>" disabled>
        ...
        <div class="inputContainer">
          ...
          <input id="addressInput" type="text" name="homeAddress" value="<?php echo $homeAddress; ?>" disabled>
          <input id="noAddressInput" type="checkbox" onclick="addressDisable(this.checked)" disabled>
          <label for="noAddressInput">N/A</label>

          <div class="secondColumnInputContainer">
            Country:&nbsp;<span id="countryWarning" class="warning"></span><br>
            <select id="countryInput" name="country" disabled>
        ...
        <div class="inputContainer">
          ...
          <input id="emailInput" type="text" name="email" value="<?php echo $email; ?>" disabled>

          <div class="secondColumnInputContainer">
            Mobile&nbsp;Number:&nbsp;<span id="mobileWarning" class="warning"></span><br>
            <input id="mobileInput" type="text" name="mobileNumber" placeholder="Eg: +60 123456789 / 0123456789" value="<?php echo $mobileNumber; ?>" disabled>
            <input id="noMobileInput" type="checkbox" onclick="mobileDisable(this.checked)" disabled>
        ...
        <div class="inputContainer">
          ...
          <input id="handicapInput" type="number" name="handicap" min="-18" max="72" step="0.1" value="<?php echo $handicap; ?>" disabled>&nbsp;
          <input id="noHandicapInput" type="checkbox" onclick="handicapDisable(this.checked)" disabled>
          <label for="noHandicapInput">N/A</label>

          <div class="secondColumnInputContainer">
            NHS&nbsp;Number:&nbsp;<span id="nhsWarning" class="warning"></span><br>
            <input id="nhsInput" type="number" name="nhsNumber" min="1" value="<?php echo $nhsNumber; ?>" disabled>
          </div>
        </div>

        <div class="inputContainer">
          Home&nbsp;Club:&nbsp;<span id="homeClubWarning" class="warning"></span><br>
          <input id="homeClubInput" type="text" name="homeClub" value="<?php echo $homeClub; ?>" disabled>
          <input id="noHomeClubInput" type="checkbox" onclick="homeClubDisable(this.checked)" disabled>
          <label for="noHomeClubInput">N/A</label>
        </div>

        <div class="inputContainer">
          Parent/Guardian&nbsp;Name:&nbsp;<span id="guardianNameWarning" class="warning"></span><br>
          <input id="guardianNameInput" type="text" name="guardianName" value="<?php echo $guardianName; ?>" disabled>

          <div class="secondColumnInputContainer">
            Parent/Guardian&nbsp;Mobile&nbsp;Number:&nbsp;<span id="guardianMobileWarning" class="warning"></span><br>
            <input id="guardianMobileInput" type="text" name="guardianMobileNumber" placeholder="Eg: +60 123456789 / 0123456789" value="<?php echo $guardianMobileNumber; ?>" disabled>
          </div>
        </div>

        <div class="inputContainer">
          T-Shirt&nbsp;Size:&nbsp;<span id="tShirtWarning" class="warning"></span><br>
          <input id="mensCutInput" class="tShirtRadios" type="radio" name="tShirtCut" value="M"<?php if ($tShirtCut == "M") { echo " checked"; } ?> disabled>
          <label for="mensCutInput">Men's&nbsp;Cut</label>&nbsp;
          <input id="ladiesCutInput" class="tShirtRadios" type="radio" name="tShirtCut" value="F"<?php if ($tShirtCut == "F") { echo " checked"; } ?> disabled>
          <label for="ladiesCutInput">Ladies'&nbsp;Cut</label>&nbsp;
          <input id="noTShirtInput" type="checkbox" onclick="tShirtDisable(this.checked)" disabled>
          <label for="noTShirtInput">N/A</label><br>
          <input id="xsSizeInput" class="tShirtRadios" type="radio" name="tShirtSize" value="XS"<?php if ($tShirtSize == "XS") { echo " checked"; } ?> disabled>
          <label for="xsSizeInput">XS</label>&nbsp;
          <input id="sSizeInput" class="tShirtRadios" type="radio" name="tShirtSize" value="S"<?php if ($tShirtSize == "S") { echo " checked"; } ?> disabled>
          <label for="sSizeInput">S</label>&nbsp;
          <input id="mSizeInput" class="tShirtRadios" type="radio" name="tShirtSize" value="M"<?php if ($tShirtSize == "M") { echo " checked"; } ?> disabled>
          <label for="mSizeInput">M</label>&nbsp;
          <input id="lSizeInput" class="tShirtRadios" type="radio" name="tShirtSize" value="L"<?php if ($tShirtSize == "L") { echo " checked"; } ?> disabled>
          <label for="lSizeInput">L</label>&nbsp;
          <input id="xlSizeInput" class="tShirtRadios" type="radio" name="tShirtSize" value="XL"<?php if ($tShirtSize == "XL") { echo " checked"; } ?> disabled>
          <label for="xlSizeInput">XL</label>&nbsp;
          <input id="xxlSizeInput" class="tShirtRadios" type="radio" name="tShirtSize" value="XXL"<?php if ($tShirtSize == "XXL") { echo " checked"; } ?> disabled>
          <label for="xxlSizeInput">XXL</label>
        </div>

        <input id="editSubmit" type="submit" value="Update Player" hidden>
      </form>
    </div>
    ...
    <?php
      ...
      {
        echo "<script>
                window.alert(\"This player no longer exists.\");
                document.getElementById(\"viewPlayersSubmit\").click();
              </script>";
      }
      else
      {
